...
$adtSession = @{
    # App variables.
    AppVendor = 'Skillbrains'					# Nome do Fabricante do Aplicativo (Ex.: Adobe)
    AppName = 'LightShot'						# Nome do Aplicativo (Ex.: Acrobat Reader)
    AppVersion = '5.5.0.7' 					    # Versão do Aplicativo (Ex.: 1.0)
    AppArch = 'X64'								# Arquitetura (Valores: X86, X64, X86-X64)
    AppLang = 'PT-BR'							# Idioma (Valores: PT-BR, EN)
    AppRevision = '02'							# Número da Revisão de Pacote do Aplicativo
    ...
    AppScriptDate = '2025-03-28'				# ATENÇÃO! Data da criação do Pacote no formato AAAA-MM-DD
    AppScriptAuthor = 'pedro.g.santos'			# Nome do Autor do Pacote
